...
export const FAQsInfo = [
  {
    ...
    answer: (
      <>
        ...
        commercial – all for one low monthly price. There's always something new
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        device, all for one fixed monthly fee. Plans range from EUR 9.39 to EUR
        13.99 a month. No extra costs, no contracts.
      </>
    ),
  },
  {
